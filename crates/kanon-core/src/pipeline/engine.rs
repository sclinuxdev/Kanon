...
pub enum PipelineResult {
    ...
    /// Inbound event passed through the pipeline without matching any slash command.
...
impl PipelineEngine {
    ...
    pub async fn process_event(&self, event: PipelineEventRequest) -> PipelineResult {
        ...
        // Phase 3: Conversational message (unmatched by command router, passed downstream)
