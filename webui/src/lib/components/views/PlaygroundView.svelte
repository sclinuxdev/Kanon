  ...
  <div class="p-3 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 flex items-center justify-between shrink-0">
    <div class="flex items-center gap-3">
      <div class="flex items-center gap-2">
        ...
        <span class="text-xs font-semibold text-zinc-900 dark:text-zinc-100">AI Sandbox</span>
      </div>
      <div class="flex items-center gap-1.5 text-xs">
        <!-- svelte-ignore a11y_label_has_associated_control -->
        <label class="text-zinc-400 font-mono text-[11px]">Session:</label>
        <input
          type="text"
  ...
  >
    {#if messages.length === 0}
      <div class="p-16 text-center space-y-3">
        ...
        <h4 class="text-sm font-semibold text-zinc-900 dark:text-zinc-100">Kanon Interactive Playground</h4>
        <p class="text-xs text-zinc-500 max-w-sm mx-auto leading-relaxed">
          Test conversational reasoning and cross-language tool calling directly against the node's unified Agent runtime.
        </p>
      </div>
    {:else}
  ...
  <div class="p-4 border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shrink-0">
    <div class="max-w-4xl mx-auto flex items-center gap-2">
      <input
        ...
        placeholder="Type a message (e.g. 'Calculate 10 + 32' or ask a question)..."
